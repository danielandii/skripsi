  ...
  <tr><td colspan="8"></td></tr>
    <tr bgcolor="#CCCCCC" align="center">
    	<td width="10%">Transaksi</td>
      	<td width="13%" bgcolor="#CCCCCC">Tanggal</td>
...
while ($isi=mysql_fetch_array($query2)) { ?>
  <tr align="center">
    	...
    	<td><a href="../admin/mengelolaLaporan.php?tag=hapus&id=<?php echo $isi['id_laporan'];?>&tbl=laporan" onclick="return confirm('Yakin akan dihapus?');">
        <img src="../lihat/delete.png" width="30" height="30" title="Hapus data laporan"/></a></td>
    </tr> 
	<?php } }?>
<tr> <td colspan="9"><table id="pagination" width="100%" height="100%" align="center"><tr><td>Halaman :
        ...
        for ($i = 1; $i <= $pages; $i++)
          {?>
          <a href="utama.php?tag=lap&opsi=lihat&<?php echo "td=$t1&ts=$t2&ad=$ad&tr=$tr"; ?>&page=<?php echo $i;?>"><?php echo $i;?></a>
          <?php           
          }
        ?>
      </td></tr></table></td></tr>
