...
<form id="form1" name="form1" method="post" action="../lihat/urutlap2.php?ad=<?php echo $_SESSION['idadmin'];?>" enctype="multipart/form-data">
  <tr>
    ...
    <td width="19%"><select name="cbox1" id="cbox1" disabled="disabled">
  ...
  <tr>
    ...
    <td></td>
    <td></td>
    <td><form id="form2" name="form2" method="post" action="../cetakLaporan.php?td=<?php echo "".$_GET['td']."&ts=".$_GET['ts']."&ad=".$_GET['ad']."&tr=".$_GET['tr']."&name=".$_SESSION['nama'].""; ?>" enctype="multipart/form-data">
